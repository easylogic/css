...
import { LOAD, POINTERSTART, MOVE, PREVENT, STOP, KEY_ALT, END, MOUSEOVER, MOUSEOUT } from "../../../../util/Event";
import { CHANGE_RECT, CHANGE_ARTBOARD, CHANGE_LAYER, CHANGE_SELECTION, CHANGE_EDITOR, COPY_ITEMS, CHANGE_INSPECTOR } from "../../../types/event";
...
export default class ItemManager extends UIElement {
    ...
    [POINTERSTART('$el .artboard-title') + PREVENT + STOP + MOVE('moveArtBoard') + END('moveEndLayer')] (e) {
    ...
    [POINTERSTART('$el .layer') + PREVENT + STOP + MOVE('moveLayer') + END('moveEndLayer')] (e) {
        ...
        if (e.altKey) {     // alt key 누르 상태로 시작하면 copy , 복사본만 움직임 
            var ids = editor.copy()
