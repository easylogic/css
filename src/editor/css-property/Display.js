...
export class Display extends Property {
    ...
    isFlex () { return this.json.type == 'flex'; }

    isGrid () { return this.json.type == 'grid'; }

    isInline () { return this.json.type == 'inline';  }

    isInlineBlock () { return this.json.type == 'inline-block';  }

    isBlock () { return this.json.type == 'block';  }
