...
test('Layer - set property', () => {
    ...
    expect(layer+"").toEqual('position: absolute;width: 100%;height: 300px;box-sizing: border-box;visibility: visible;background-color: black;word-wrap: break-word;word-break: break-word');
})